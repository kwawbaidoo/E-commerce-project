        ...
        <div className="flex w-full   ">
          <span className="flex justify-between  w-full   ">
            ...
            <ul className="flex gap-10 font-poppins text-base items-center justify-center w-full">
              ...
              className="position-relative">
                <Link><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none"><path d="M3 7h18M3 12h18M3 17h18" stroke="#DB4444" strokeWidth="1.5" strokeLinecap="round"></path></svg></Link>
          ...
          <div className="flex justify-between w-full ">
            <span className="flex w-full justify-center bg-customgray  items-center ">
              ...
              <span className="py-3 px-4 cursor-pointer rounded-md bg-customred text-white shadow-md border">
                Search
              </span>
            </span>
